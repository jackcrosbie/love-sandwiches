...
def update_worksheet(data, worksheet):
    """
    Receive list of integers to be inserted into worksheet.
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined by the sale figure subtracted from the stock:
    - Positive surplus indicates waste
    - Negative surplus indicates extra made when stock ran out.
    """
    print("Surplus calculation starting...\n")
